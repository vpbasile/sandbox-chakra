import { Input, RadioGroup, Radio, Box, Text, SimpleGrid, Card, CardBody, CardFooter, CardHeader, Heading, Stack, useColorModeValue, Button, ChakraProvider } from "@chakra-ui/react";
import { Department, Officer, deptMap, hugeSize, rankMap } from "./constants";
import Uniform from "./uniform";
import { useState } from "react";
import starfleetTheme from "../theming/themeStarfleet";
import Fonts from "../theming/fontConfig";
